...
namespace BrunoMikoski.ServicesLocation
{
    public static class ServiceLocatorCodeGenerator
    {
        ...
        internal static bool GenerateServicesClass()
        {
            ...
            output.AppendLine("// This file is auto-generated by the Service Locator package.");
            output.AppendLine($"using {typeof(ServiceLocator).Namespace};");
            output.AppendLine();
            output.AppendLine($"namespace {ServiceLocatorSettings.Instance.TargetNamespace}");
            output.AppendLine("{");
